...
public class Gvr_WorldScale : MonoBehaviour
{

    public Gvr_NewController steamCtlMain;
    public Gvr_NewController steamCtlAlt;
    ...
    private void attachTargetOne(ref Gvr_NewController ctl) {
